...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post payment_methods_url, params: { payment_method: { name_en: @payment_method.name_en, name_es: @payment_method.name_es, name_fr: @payment_method.name_fr } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { name_en: @payment_method.name_en, name_es: @payment_method.name_es, name_fr: @payment_method.name_fr } }
