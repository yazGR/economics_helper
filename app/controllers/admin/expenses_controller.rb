module Admin
  class ExpensesController < Admin::ApplicationController
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_expenses_path, status: :see_other, notice: "Expense was successfully destroyed." }
    ...
    private
      ...
      def expense_params
        params.require(:expense).permit(:user_id, :expensetable_id, :expensetable_type, :amount, :date, :note)
      end
  end  
end
